...
const handleSearch = () => {
    // 处理搜索逻辑
    getMenuList(formInline).then(res => {
    ...
    <div class="page">
        <div class="form">
            <el-form inline :model="formInline" class="demo-form-inline">
                <el-form-item label="菜单名称">
                    <el-input v-model="formInline.menuName" placeholder="菜单名称" />
                </el-form-item>
                <el-form-item>
        ...
        <div class="table">
            ...
            >
                ...
                <el-table-column prop="name" label="菜单名称" width="240" header-align="center" />
                ...
                <el-table-column prop="path" label="菜单路径" header-align="center" />
                <el-table-column prop="status" label="菜单状态" width="150" align="center">
